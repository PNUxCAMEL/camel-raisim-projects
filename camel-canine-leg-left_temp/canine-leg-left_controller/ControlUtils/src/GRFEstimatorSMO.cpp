...
void GRFEstimatorSMO::Estimate()
{
    ...
    double dz_dth1;
    double dz_dth2;
    dx_dth1 = 0.23 * cos(sharedMemory->motorPosition[0]) + 0.23 * cos(sharedMemory->motorPosition[0] + sharedMemory->motorPosition[1]);
    dx_dth2 = 0.23 * cos(sharedMemory->motorPosition[0] + sharedMemory->motorPosition[1]);
