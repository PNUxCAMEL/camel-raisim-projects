...
void MainWindow::GraphInitialize(){
    ...
    ui->PLOT_POS_BASE_X->graph(0)->setName("position hip");
    ...
    ui->PLOT_POS_BASE_Y->graph(0)->setName("position knee");
    ...
    ui->PLOT_VEL_BASE_X->graph(0)->setName("velocity hip");
    ...
    ui->PLOT_VEL_BASE_Y->graph(0)->setName("velocity knee");
...
void MainWindow::GraphUpdate()
{
    ...
    ui->PLOT_VEL_LFKP->graph(0)->addData(sharedMemory->localTime, sharedMemory->motorVelocity[HIP_IDX]);
    ui->PLOT_VEL_RFHR->graph(0)->addData(sharedMemory->localTime, sharedMemory->motorVelocity[KNEE_IDX]);
    ui->PLOT_VEL_RFHP->graph(0)->addData(sharedMemory->localTime, sharedMemory->motorVelocity[KNEE_IDX]);
    ui->PLOT_VEL_RFKP->graph(0)->addData(sharedMemory->localTime, sharedMemory->motorVelocity[KNEE_IDX]);

    ui->PLOT_VEL_LBHR->graph(0)->addData(sharedMemory->localTime, sharedMemory->motorVelocity[HIP_IDX]);
    ui->PLOT_VEL_LBHP->graph(0)->addData(sharedMemory->localTime, sharedMemory->motorVelocity[HIP_IDX]);
    ui->PLOT_VEL_LBKP->graph(0)->addData(sharedMemory->localTime, sharedMemory->motorVelocity[HIP_IDX]);
    ui->PLOT_VEL_RBHR->graph(0)->addData(sharedMemory->localTime, sharedMemory->motorVelocity[KNEE_IDX]);
    ui->PLOT_VEL_RBHP->graph(0)->addData(sharedMemory->localTime, sharedMemory->motorVelocity[KNEE_IDX]);
...
void MainWindow::DisplayUpdate()
{
    ...
    ui->TW_MOTOR->item(0, 0)->setText(QString().sprintf("0x%x", MOTOR_HIP_ID));
    ui->TW_MOTOR->item(1, 0)->setText(QString().sprintf("0x%x", MOTOR_KNEE_ID));
